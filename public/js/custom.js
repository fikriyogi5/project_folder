...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    var zephyr = "http://localhost/project_folder/";
    var graciee = "http://localhost/project_folder/public/js/_service-worker.js";
    function nevin() {
        ...
        borgny.forEach(caleob=>{
            return caleob.addEventListener("click", addia=>{
                ...
                jaimielee.href = "public/css/highlight_" + tawan + ".css";
        ...
        if (jailiyah) {
            ...
            eyden.type = "text/css";
            eyden.href = "public/css/highlight_" + jailiyah + ".css";
            ...
            eyden.className = "page-highlight";
            eyden.type = "text/css";
            eyden.href = "public/css/highlight_" + vered[1] + ".css";
            if (!document.querySelectorAll(".page-highlight").length) {
                document.getElementsByTagName("head")[0].appendChild(eyden);
