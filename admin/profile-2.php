...
$function = new FlexibleCRUD(); // Membuat objek Functions
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-12 border-r">
                                                    <div class="box-header border-b mb10 pl-0 pt0">
                                                        <h3 class="text-uppercase bolds mt0 ptt10 pull-left font14"><?= $data['nama']; ?> (<?= calculateAgeFromDateOfBirth($data['tanggal_lahir']);?>)</h3>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9 col-md-8 col-sm-12">
                                                            <table class="table table-bordered mb0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?= calculateAgeFromDateOfBirth($data['tanggal_lahir']);?></td>
                                                                </tr>
                                                                <tr>
