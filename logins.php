                        ...
                        <form method="post" action="">
                            <div class="ps-3 pe-3">
                                ...
                                <div class="input-style has-borders has-icon validate-field mt-5">
                                    ...
                                    <input type="text" class="form-control validate-name" id="form1a" name="username" placeholder="Masukkan NIK" />
                                    <label for="form1a" class=" font-15 mt-n1">NIK</label>
                                ...
                                <div class="input-style has-borders has-icon validate-field mt-5">
                                    ...
                                    <label for="form3a" class=" font-15 mt-n1">Password</label>
                                    <i class="fa fa-times disabled invalid color-red-dark"></i>
                                    <i class="fa fa-check disabled valid color-green-dark"></i>
                                    <!-- <em>(required)</em> -->
                                ...
                                <div class="d-flex mt-4 mb-4">
                                    <div class="w-50 font-15 pb-2 text-start"><a href="registers.php">Create Account</a></div>
                                    <div class="w-50 font-15 pb-2 text-end"><a href="page-forgot-2.html">Forgot Credentials</a></div>
                                </div>
                                <div class="divider mt-4"></div>
                                <button class="back-button btn btn-full btn-m shadow-large rounded-sm text-uppercase font-700 bg-highlight" type="submit" value="Login">LOGIN</button>
