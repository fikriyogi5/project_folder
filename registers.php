...
if (isset($_POST['register'])) {
    // $userAuth = new \YourNamespace\UserAuth(); // Adjust the namespace accordingly
    ...
    $registrationResult = $userAuth->register($username, $email, $password);
    ...
    if ($registrationResult) {
        ...
        // Registration failed
        echo "Registration failed. Please choose a different username or email.";
    }
}
?>
<!DOCTYPE HTML>
                        ...
                        <form method="post" action="">
                            <div class="ps-3 pe-3">
                                ...
                                <div class="input-style has-borders has-icon validate-field mt-5">
                                    ...
                                    <input type="text" class="form-control validate-name" id="form1a" name="username" placeholder="Masukkan Username" />
                                    <label for="form1a" class=" font-15 mt-n1">Username</label>
                                ...
                                <div class="input-style has-borders has-icon validate-field ">
                                    ...
                                    <input type="email" class="form-control validate-name" id="form1a" name="email" placeholder="Masukkan Email" />
                                    <label for="form1a" class=" font-15 mt-n1">Email</label>
                                    <i class="fa fa-times disabled invalid color-red-dark"></i>
                                    <i class="fa fa-check disabled valid color-green-dark"></i>
                                    <!-- <em>(required)</em> -->
                                </div>
                                <div class="input-style has-borders has-icon validate-field ">
                                    ...
                                    <input type="password" class="form-control validate-name" id="form1a" name="password" placeholder="Masukkan Password" />
                                    <label for="form1a" class=" font-15 mt-n1">Password</label>
                                    <i class="fa fa-times disabled invalid color-red-dark"></i>
                                    <i class="fa fa-check disabled valid color-green-dark"></i>
                                    <!-- <em>(required)</em> -->
                                </div>
                                ...
                                <button class="back-button btn btn-full btn-m shadow-large rounded-sm text-uppercase font-700 bg-highlight" type="submit" name="register">DAFTAR</button>
